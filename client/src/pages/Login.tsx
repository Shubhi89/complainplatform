...
const Login = () => {
  // State to track which role is selected (Default: CONSUMER)
  const [role, setRole] = useState<'CONSUMER' | 'BUSINESS'>('CONSUMER');

  // This function redirects the user to your Backend Google Auth endpoint
  const handleGoogleLogin = () => {
    // We attach the role as a query parameter so the backend knows!
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-800 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-10">
          <h1 className="text-5xl font-bold text-white mb-6">Bridge the Gap.</h1>
          <p className="text-xl text-slate-300 max-w-md mx-auto">
            The modern platform for resolving commercial disputes with speed and transparency.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-10 border border-gray-100">
          ...
          {/* Dynamic Color Line */}
          <div className={`h-1 w-full rounded-full mb-8 transition-colors duration-300 ${
          ...
          <div className="mt-8 text-center border-t border-gray-100 pt-6">
            <a href="/admin/login" className="inline-flex items-center text-sm text-gray-600 hover:text-red-500 transition-colors">
